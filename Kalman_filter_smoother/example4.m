% -----------------------------------------------------------------------
% Example 4: Solution to a Neoclassical Growth Model via Uhlig's Toolkit.
%
...
[X, logL, SmoothedStates] = smooth(mdl, log_deviation, 'params',params_0);
