% -----------------------------------------------------------------------
% Example 3: Solution to a Neoclassical Growth Model via Uhlig's Toolkit.
%
...
[Kt, log_like_cum, states_filtered, P_filtered, P_predicted] = kalman_filter(Y, SSM);
...
%% Plot the filtered states with calibrated parameters
    ...
    print(fig, 'eg_3_filtered_vs_smoothed', ['-d' fig_fmt]);


%% Save filtered output:
save('example3.mat', 'states_smoothed', 'dates');
